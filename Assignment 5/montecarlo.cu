...
int main(int argc, char* argv[ ]){
  ...
  double megaTrialsPerSecond = (double)NUMTRIALS / (msecTotal) / 1000000.;
  ...
  fprintf(stderr, "%2d, %8d,%6.5f%%,%6.8f\n",BLOCKSIZE, NUMTRIALS, 100.*probability, maxPerformance);
  //fprintf(stderr, "BLOCKSIZE: %2d, %8d trials; probability = %6.5f%%; megatrials/sec = %6.8f\n",BLOCKSIZE, NUMTRIALS, 100.*probability, maxPerformance);
